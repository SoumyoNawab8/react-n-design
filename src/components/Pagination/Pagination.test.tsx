...
describe('Pagination', () => {
  it('renders pagination with page numbers', () => {
    renderWithTheme(
      <Pagination currentPage={1} totalPages={5} onChange={vi.fn()} />
    );
  ...
  it('calls onChange when page is clicked', () => {
    ...
    renderWithTheme(
      <Pagination currentPage={1} totalPages={5} onChange={onChange} />
    );
  ...
  it('does not call onChange when clicking current page', () => {
    const onChange = vi.fn();
    renderWithTheme(
      <Pagination currentPage={2} totalPages={5} onChange={onChange} />
    );
  ...
  it('shows ellipsis when there are many pages', () => {
    renderWithTheme(
      <Pagination currentPage={5} totalPages={10} onChange={vi.fn()} />
    );
  ...
  it('has previous and next buttons', () => {
    renderWithTheme(
      <Pagination currentPage={3} totalPages={5} onChange={vi.fn()} />
    );
  ...
  it('disables next button on last page', () => {
    renderWithTheme(
      <Pagination currentPage={5} totalPages={5} onChange={vi.fn()} />
    );
  ...
  it('sets aria-current on active page', () => {
    renderWithTheme(
      <Pagination currentPage={2} totalPages={5} onChange={vi.fn()} />
    );
  ...
  it('disables all buttons when disabled prop is true', () => {
    renderWithTheme(
      <Pagination currentPage={3} totalPages={5} onChange={vi.fn()} disabled />
    );
