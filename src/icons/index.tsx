...
const createIcon = (children: React.ReactNode, viewBox = '0 0 24 24') =>
  React.forwardRef<SVGSVGElement, IconSvgProps>((
    { size = '1em', color = 'currentColor', className, ...props },
    ref
  ) => (
    <svg
      ref={ref}
...
export const FaRobot = createIcon(
  <><path d="M21 10V8C21 6.9 20.1 6 19 6H17V4C17 2.9 16.1 2 15 2H9C7.9 2 7 2.9 7 4V6H5C3.9 6 3 6.9 3 8V10C1.9 10 1 10.9 1 12V18C1 19.1 1.9 20 3 20H5V22H7V20H17V22H19V20H21C22.1 20 23 19.1 23 18V12C23 10.9 22.1 10 21 10ZM15 4V6H9V4H15ZM5 18H3V12H5V18ZM5 10V8H19V10H5ZM21 18H19V12H21V18Z" /><path d="M9 14H7V16H9V14ZM17 14H15V16H17V14Z" /></>,
  '0 0 24 24'
);
...
export const FaStarHalf = createIcon(
  <><defs><linearGradient id="halfStar"><stop offset="50%" stopColor="currentColor"/><stop offset="50%" stopColor="transparent"/></linearGradient></defs><path fill="url(#halfStar)" d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" /></>,
  '0 0 24 24'
);
