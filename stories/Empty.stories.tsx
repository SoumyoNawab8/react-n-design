  ...
  args: {
    ...
    image: (
      <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <path d="M20 28C20 28 24 36 32 36C40 36 44 28 44 28" stroke="#d9d9d9" strokeWidth="3" strokeLinecap="round"/>
...
export const EmptyWithLongDescription: Story = {
  args: {
    description: 'No matching records found. Try adjusting your search criteria or filters to find what you\'re looking for.',
  },
};
