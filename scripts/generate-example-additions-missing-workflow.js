export const meta = {
  name: 'generate-example-additions-missing',
  description:
    'Use sub-agents to generate five new example snippets for the components missed by the first run.',
  phases: [
    {
      title: 'Generate',
      detail: 'Agents produce five example snippets per missing component group.',
    },
...
const GROUPS = [
  ...
  ['ComboBox', 'GanttChart', 'GradientBorder', 'Icon', 'OrgChart', 'VirtualList', 'VisuallyHidden'],
];
...
log(`Combined ${Object.keys(combined.additions).length} missing component additions.`);
...
- render must be a complete inline arrow function body string, e.g. render: "() => (\n  <Stack direction=\\"row\\" gap={12}>...\n  </Stack>\n)".
